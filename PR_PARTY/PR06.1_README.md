...
**What:** Destructive trim system with timeline-based controls. All trim functionality consolidated into the timeline for a professional video editor experience.

**Why:** Users expect "trim" to delete parts immediately. Timeline-based trimming is more intuitive than sidebar controls.
...
**Checkpoint:** Trimmed clip replaces original in timeline ✓
